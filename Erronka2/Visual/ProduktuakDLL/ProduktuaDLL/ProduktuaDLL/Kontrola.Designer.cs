...
namespace ProduktuaDLL
{
    partial class Kontrola
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.produktuakTableAdapter = new ProduktuaDLL.TxispakDataSetTableAdapters.ProduktuakTableAdapter();
            this.salmentakBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.salmentakTableAdapter = new ProduktuaDLL.TxispakDataSetTableAdapters.SalmentakTableAdapter();
